...
public class InquilinosDAO {
	...
	// aqui tambem mostra a tela principal, acresentei o campo de outra tabela(imoveis)
	public ArrayList<Inquilinos> listar() throws SQLException {
		...
		sql.append("SELECT q.codigo, q.nomeinq, q.cpf, q.rg, q.profissao, q.email,"
			...
			+ "q.cidadecom, q.ufcom, q.cepcom, q.telefonecom, q.celularcom, i.codigo, i.nome, i.valoraluguel ");
		...
		while (resultado.next()) {
			...
			i.setValoraluguel(resultado.getDouble("i.valoraluguel"));
